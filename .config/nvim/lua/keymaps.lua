...
vim.api.nvim_set_keymap('n', '<Space>', '<NOP>', { noremap = true, silent = true }) -- set the leader key to space
vim.g.mapleader = ' '
...
vim.api.nvim_set_keymap('n', '<leader>pf',
  '<cmd>lua require("telescope.builtin").git_files({layout_strategy="vertical",show_untracked=true,layout_config={width=0.99}})<CR>',
  { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>ps',
  '<cmd>lua require("telescope.builtin").live_grep({layout_strategy="vertical",layout_config={width=0.99}})<CR>',
  { noremap = true, silent = true })
...
vim.api.nvim_set_keymap('n', 'gr',
  '<cmd>lua require("telescope.builtin").lsp_references({layout_strategy="vertical",layout_config={width=0.99},fname_width=100})<CR>',
  { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', 'gs',
  '<cmd>lua require("telescope.builtin").treesitter({layout_strategy="vertical",layout_config={width=0.99}})<CR>',
  { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>q', '<cmd>lua vim.lsp.buf.code_action()<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<leader>fs', '<cmd>lua require("telescope.builtin").spell_suggest()<CR>',
  { noremap = true, silent = true })
